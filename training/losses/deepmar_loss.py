...
class DeepMARLoss(nn.Module):
    ...
    """
    def __init__(self, positive_attribute_ratios, use_gpu=True, sigma=1):
    ...
    def forward(self, inputs, targets):
        ...
        loss = self.loss_function(inputs, targets, weight=self.weights)
        return loss
    ...
    def _update_batch_size(self, batch_size):
        ...
        self.weights = torch.zeros((batch_size, self.num_classes), dtype=torch.float)
